      ...
      <g transform="matrix(1.25,0,0,-1.25,0,140.375)" id="g10">
        <g transform="scale(0.1,0.1)" id="g12">
          <path
            id="path14"
            style={{
              fill: '#283b82', fillPpacity: '1', fillRule: 'nonzero', stroke: 'none'
            }}
          ...
          <path
            id="path16"
            style={{
              fill: '#283b82', fillOpacity: '1', fillRule: 'nonzero', stroke: 'none'
            }}
          ...
          <path
            id="path20"
            style={{
              fill: '#469bdb', fillOpacity: '1', fillRule: 'nonzero', stroke: 'none'
            }}
